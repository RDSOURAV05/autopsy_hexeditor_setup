# Autopsy & HxD Hex Editor Setup

This repository contains documentation and setup instructions for configuring forensic tools: **Autopsy Forensic Browser** and **HxD Hex Editor**.
...
If you need to download the tools directly:
- **HxD Hex Editor**: [Official Download Page](https://mh-nexus.de/en/hxd/)
- **Autopsy Forensic Browser**: [Official Download Page](https://www.autopsy.com/download/)
